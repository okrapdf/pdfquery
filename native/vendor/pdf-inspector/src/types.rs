...
pub(crate) struct FontWidthInfo {
    ...
    pub(crate) widths: HashMap<u16, f32>,
...
pub struct TextItem {
    ...
    pub mcid: Option<i64>,
    /// Full text-rendering transform before page viewport normalization.
    /// `pdfquery` uses this to preserve rotated/angled glyph geometry.
